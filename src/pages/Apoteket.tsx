      ...
      <main className="flex-1 w-full">
        ...
        <div className="flex flex-col items-start md:items-center pt-2 md:pt-[88px] pb-2 md:pb-0 md:px-8 w-full">
          <div className="flex flex-col md:max-w-[453px]">
            ...
            <div className="flex flex-col w-full mt-4 md:mt-0">
              {[
                { text: "The site had a lot of Inconsistent behaviors and graphical expressions", pt: "pt-0 md:pt-10" },
                ...
                <div key={i} className={`pl-[40px] md:pl-[16px] ${pt}`}>
                  <ul className="[word-break:break-word] block font-['Poppins:Light',sans-serif] leading-[0] not-italic text-base text-black w-full md:w-[437px]">
        ...
        <div className="flex flex-col items-start md:items-center pt-6 md:pt-[136px] md:px-8 w-full">
          <div className="flex flex-col md:max-w-[453px]">
            ...
            <div className="px-6 md:px-0 mt-0 md:mt-8">
              <div className="[word-break:break-word] font-['Poppins:Light',sans-serif] leading-[0] not-italic text-base text-black w-full md:max-w-[453px]">
            ...
            <div className="flex flex-col pt-4 md:pt-0 pb-2 md:pb-0 w-full">
              {[
                { text: "Typography", pt: "pt-0 md:pt-[88px]" },
          ...
          <div className="w-full mt-0 md:mt-12">
            <img alt="" className="w-full aspect-square object-cover block" src={imgApoteket2} />
          </div>
        </div>
        ...
        <div className="flex flex-col items-start md:items-center pt-6 md:pt-[136px] md:px-8 w-full">
          ...
          <div className="w-full mt-4 md:mt-12">
            <img alt="" className="w-full aspect-square object-cover block" src={imgApoteket3} />
          </div>
        </div>
        ...
        <div className="flex flex-col items-start md:items-center pt-6 md:pt-24 md:px-8 w-full">
          <div className="flex flex-col md:max-w-[453px]">
            ...
            <div className="px-6 md:px-0 pt-2 md:pt-4">
              <p className="[word-break:break-word] font-['Poppins:Light',sans-serif] leading-[1.8rem] not-italic text-base text-black w-full md:max-w-[453px]">Apoteket had a beautiful new graphic profile which unfortunately neither the website or app followed.</p>
            </div>
            <div className="px-6 md:px-0 pt-4">
              <p className="[word-break:break-word] font-['Poppins:Light',sans-serif] leading-[1.8rem] not-italic text-base text-black w-full md:max-w-[453px]">The website was in other words looking one way, while the stores and products looked completely different.</p>
            </div>
            <div className="px-6 md:px-0 pt-4">
        ...
        <div className="flex flex-col items-start md:items-center pt-6 md:pt-44 md:px-8 w-full">
          <div className="flex flex-col md:max-w-[453px]">
            ...
            <div className="px-6 md:px-0 pt-6 md:pt-8">
              <p className="[word-break:break-word] font-['Poppins:Light',sans-serif] leading-[1.8rem] not-italic text-base text-black w-full md:max-w-[453px]">One of the challenges was that there was a lot of different expressions on the website. The Design System could easily take height for this.</p>
            </div>
            <div className="px-6 md:px-0 pt-4">
              <p className="[word-break:break-word] font-['Poppins:Light',sans-serif] leading-[1.8rem] not-italic text-base text-black w-full md:max-w-[453px]">We made it easy to get an overview of all the components so that the website could keep it{"'"}s structure and consistent behaviour.</p>
            </div>
          </div>
          <div className="w-full mt-2 md:mt-12">
            <img alt="" className="w-full aspect-square object-cover block" src={imgApoteket5} />
          </div>
        </div>
        ...
        <div className="flex flex-col items-start md:items-center pt-8 md:pt-[136px] md:px-8 w-full">
          <div className="flex flex-col md:max-w-[453px]">
            ...
            <div className="px-6 md:px-0 pt-2 md:pt-4">
              <div className="[word-break:break-word] font-['Poppins:Light',sans-serif] leading-[0] not-italic text-base text-black tracking-[-0.016px] w-full md:max-w-[453px]">
          ...
          <div className="w-full mt-0 md:mt-12">
            <img alt="" className="w-full aspect-[390/389] md:aspect-square object-cover block" src={imgApoteket4} />
          </div>
        </div>
      </main>
