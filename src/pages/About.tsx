...
export default function About({ onNavigate }: AboutProps) {
  return (
    <div className="bg-white min-h-screen flex flex-col page-enter">
      ...
      <header className="relative shrink-0 w-full">
        ...
        <div className="md:hidden flex items-center justify-between px-[16px] py-[26px]">
          ...
          <nav className="flex gap-[16px]">
            <button onClick={() => onNavigate("home")} className="font-['Poppins:Light',sans-serif] text-black text-[16px] leading-[28.8px] not-italic cursor-pointer hover:opacity-60 transition-opacity duration-[400ms] ease-in-out">Home</button>
            <button onClick={() => onNavigate("about")} className="font-['Poppins:Light',sans-serif] text-black text-[16px] leading-[28.8px] not-italic cursor-pointer underline decoration-1 underline-offset-4">About</button>
          </nav>
        </div>
        {/* Desktop header */}
      ...
      {/* Content */}
      <main className="flex-1 w-full px-[23px] md:px-[29px]">
        {/* Photo + intro */}
